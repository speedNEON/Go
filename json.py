...
#========================
                elif "เบิดกระโหลก " in msg.text:
                        เบิดกระโหลกick0 = msg.text.replace("เบิดกระโหลก ","")
                        เบิดกระโหลกick1 = เบิดกระโหลกick0.rstrip()
                        เบิดกระโหลกick2 = เบิดกระโหลกick1.replace("@","")
                        เบิดกระโหลกick3 = เบิดกระโหลกick2.rstrip()
                        _name = เบิดกระโหลกick3
